...
public class SkypeTest {
	public static void main(String[] args) {
		Skype skype = new Skype("rahulrajanqa@gmail.com", "Sample987*#");
		try {
		...
		for (User user : skype.getContacts()) {
			System.out.println("Sending Message to : " + user.getFirstname() + " " + user.getLastname() + " Username : " + user.getUsername());
